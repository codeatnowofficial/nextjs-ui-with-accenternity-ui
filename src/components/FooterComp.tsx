...
function FooterComp() {
  return (
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-gradient-to-b dark:from-black dark:to-neutral-800 dark:bg-opacity-50 dark:text-neutral-200 lg:text-left">
